                ...
                <form action="POST" className="flex flex-col w-[400px] max-w-[90%]" data-netlify="true" name="contact">
                    ...
                    >
                        {email && message ? (
                            ...
                            <>{!email ? "What's your email?" : "Don't be shy"}</>
                        )}
                    </button>
                </form>
            </div>
            <Section.CTO>
                You can to contact me at{" "}
                <a className="transiton duration-200 ease-in-out text-gray-400 inline-block underline hover:text-gray-800" href="mailto:victor@vimtor.io">
                    victor@vimtor.io
                </a>
                <br />
