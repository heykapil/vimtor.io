  ...
  return (
    <Section className="opacity-0 animate-fade-in-down animation-delay-2000 text-center mt-24 sm:mt-32">
      ...
      <div className="flex justify-center">
        <ul className="list-disc list-inside text-left m-0 text-base sm:text-xl leading-7">
          <li>
            ...
            <a
              className="transiton duration-200 ease-in-out text-gray-400 inline-block underline hover:text-gray-800"
      ...
      <Section.CTO>
        ...
        <a
          className="transiton duration-200 ease-in-out text-gray-400 underline hover:text-gray-800"
          href="https://stackshare.io/vimtor/my-stack"
        >
          stackshare.io
        </a>
      </Section.CTO>
