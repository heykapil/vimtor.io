    ...
    page?:
        | {
              ...
              projects: Array<{
                  ...
                  summary: { __typename?: "RichText"; raw: any };
                  technologies: Array<{ __typename?: "Technology"; slug: string }>;
                  type?: { __typename?: "ProjectType"; name: string; slug: string } | null | undefined;
              }>;
          }
        | null
        | undefined;
...
export type GetProjectsPageQuery = {
    __typename?: "Query";
    technologies: Array<{ __typename?: "Technology"; name: string; slug: string }>;
    projectTypes: Array<{ __typename?: "ProjectType"; name: string; slug: string }>;
    projects: Array<{
        __typename?: "Project";
        name: string;
        slug?: string | null | undefined;
...
export type TechnologyLevelSummaryFragment = {
    __typename?: "TechnologyLevel";
    name: string;
    description: string;
    technologies: Array<{ __typename?: "Technology"; name: string; slug: string; icon: { __typename?: "Asset"; url: string } }>;
};

export type GetTechnologiesPageQueryVariables = Exact<{ [key: string]: never }>;

export type GetTechnologiesPageQuery = {
    __typename?: "Query";
    page?:
        | {
              __typename?: "TechnologiesPage";
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        getHomePage(variables?: GetHomePageQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetHomePageQuery> {
            return withWrapper(
                (wrappedRequestHeaders) => client.request<GetHomePageQuery>(GetHomePageDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
                "getHomePage"
            );
        },
        getProjectsPage(variables?: GetProjectsPageQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetProjectsPageQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetProjectsPageQuery>(GetProjectsPageDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
                "getProjectsPage"
            );
        },
        getTechnologiesPage(variables?: GetTechnologiesPageQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetTechnologiesPageQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetTechnologiesPageQuery>(GetTechnologiesPageDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
                "getTechnologiesPage"
            );
        },
    };
